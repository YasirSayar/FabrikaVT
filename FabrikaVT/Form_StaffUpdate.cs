...
namespace FabrikaVT
{
    public partial class Form_StaffUpdate : Form
    {
        ...
        public Form_StaffUpdate()
        {
            InitializeComponent();
        }

        private void Form_StaffUpdate_Load(object sender, EventArgs e)
        {
            ...
            dataGridView_staffUpdate.Columns["id"].Visible = false;
        ...
        private void dataGridView_staffAdd_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            labelGizliid.Text = dataGridView_staffUpdate.Rows[e.RowIndex].Cells["id"].Value.ToString();
        ...
        private void buttonEkle_Click(object sender, EventArgs e)//button update
        {
            if (TextBoxesAreNotEmpty())
            {
                ...
                {
                    using (SqlCommand command = new SqlCommand("UPDATE Staff SET f_name = @Param1, l_name = @Param2, email = @Param3, adress = @Param4, s_birthday = @Param5, s_phone = @Param6 WHERE staff_id = @StaffId", connection))
                    {
        ...
        private void dataGridView_staffUpdate_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
