...
namespace FabrikaVT
{
    public partial class FormProductStaffSil : Form
    {
        ...
        private void FormProductStaffSil_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                using (SqlCommand command = new SqlCommand("DELETE FROM Product WHERE  product_id = @custıd", connection))
                {

                    command.Parameters.AddWithValue("@custıd", productid);
