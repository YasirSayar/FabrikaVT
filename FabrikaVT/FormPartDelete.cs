...
namespace FabrikaVT
{
    public partial class FormPartDelete : Form
    {
        ...
        public FormPartDelete()
        {
            InitializeComponent();
        }

        private void FormPartDelete_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                using (SqlCommand command = new SqlCommand("DELETE FROM Part WHERE  part_id = @custıd", connection))
                {

                    command.Parameters.AddWithValue("@custıd", partid);
            ...
            // dataGridView1'deki product_id sütununu gizle
            dataGridView1.Columns["part_id"].Visible = false;
            dataGridView1.Columns["suplier_id"].Visible = false; dataGridView1.Columns["part_id"].Visible = false;
            // DataGridView'e veriyi yükleyin
            dataGridView1.DataSource = dataTable;
